...
+
image:load-balancer-monitor-configuration-page.png["[Monitor]設定ページ"]
...
image:load-balancer-citrix-netscaler-configuration-page.png["Citrix NetScaler Monitorの構成ページ"]
